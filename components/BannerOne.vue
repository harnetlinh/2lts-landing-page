            ...
            <div class="row align-items-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="banner-text-inner">
                        ...
                        <h1 style="" >Hành chính đúng <br>thời điểm</h1>
                        <a href="#pricing" class="btn">Tra cứu dịch vụ</a>
                        <a href="#" class="btn">Ứng dụng quản lý</a>
                    </div>
                    <!-- banner text -->
                </div>
                <div class="col-lg-6 offset-lg-1 col-md-5 offse-xl-2">
                    <!-- banner image-->
                    <div class="banner-image">
                        <img src="/assets/img/banner/mockup.png" alt="" width="160%">
                    </div>
                    <!--End of banner image-->
                </div>
            </div>
